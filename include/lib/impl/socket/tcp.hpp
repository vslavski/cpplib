 ...
 */
#ifndef CPPLIB__lib__impl__socket__tcp__hpp
#define CPPLIB__lib__impl__socket__tcp__hpp

#include "../../../lib/debug/os.hpp"
#include "../../../lib/debug/platform.hpp"

#if defined(CPPLIB_PLATFORM_POSIX)
	#include "../../../lib/impl_posix/socket/tcp.hpp"
#elif defined(CPPLIB_OS_WINDOWS)
	#include "../../../lib/impl_windows/socket/tcp.hpp"
#else
...
#endif // CPPLIB__lib__impl__socket__tcp__hpp
